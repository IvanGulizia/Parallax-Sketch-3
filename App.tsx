            ...
            <div className="space-y-3 text-sm text-gray-600">
                ...
                {!isEmbed && (
                    <>
                        ...
                        <div className="flex justify-between items-center pb-2 border-b border-gray-100">
                            <span>Lock View (While Playing)</span>
                        ...
                        <div className="flex justify-between items-center pb-2 border-b border-gray-100">
                            ...
                            <div className="flex gap-1"><kbd className="px-2 py-0.5 bg-gray-100 rounded border border-gray-200 font-mono text-xs">J</kbd></div>
                        </div>
                    </>
                )}
                {isEmbed && (
...
export default function App() {
  ...
  // New state to signal view lock/reset to DrawingCanvas
  // Supports 'UNLOCK' to clear lock when returning to play mode
  ...
  const handleTogglePlay = async () => {
    ...
    // Logic for View Lock: If we are turning PLAY ON, we must UNLOCK the view.
    if (!state.isPlaying) {
  ...
  return (
    ...
    >
      ...
      <div className={`w-full flex flex-col items-center justify-center pb-0 scroll-layer-area ${state.isEmbedMode ? 'p-0 pb-0' : ''}`}>
        <div 
